...
{
    public class RoomServerBehaviour : ServerBehaviour, ITerminatableRoom
    {
        #region INSPECTOR
        ...
        /// </summary>
        protected Dictionary<int, IRoomPlayerPeerExtension> roomPlayersByMsfPeerId;
        ...
        /// </summary>
        public static RoomServerBehaviour Instance { get; protected set; }
        ...
        /// </summary>
        public event Action<IRoomPlayerPeerExtension> OnPlayerJoinedRoomEvent;

        /// <summary>
        /// Fires when existing player left room
        /// </summary>
        public event Action<IRoomPlayerPeerExtension> OnPlayerLeftRoomEvent;
        ...
        {
            roomPlayersByMsfPeerId.TryGetValue(peerId, out IRoomPlayerPeerExtension user);
            return user;
        }
