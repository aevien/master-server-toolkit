...
namespace MasterServerToolkit.Bridges.MirrorNetworking.Character
{
    public class PlayerCharacterLook : PlayerCharacterBehaviour
    {
        ...
        [Header("Base Settings"), SerializeField, Tooltip("Legacy prefab setting retained for compatibility. PlayerCharacterLook currently restores the owning client's camera whenever authority stops, regardless of this value.")]
